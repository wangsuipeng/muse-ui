        ...
        <div class="content-main">
            <div class="camera-photo" ref="divGenres" v-show="isPhoto" @click="choiceImg">
                <img
                    ...
                    src="https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/timg?image&quality=100&size=b4000_4000&sec=1528077222&di=69a2ffcffd12e35216ab71da7a610abe&src=http://img.zcool.cn/community/01f15555b4df7e6ac725ca50c172a1.png@2o.png"
                />
                <br />
                <span>请选择图片上传</span>
                <input
